...
--
-- Name: growth-mgk_2021-11-29; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."growth-mgk_2021-11-29" (
    id integer NOT NULL,
    name text,
    off_hi double precision,
    gain_factor double precision
...
ALTER TABLE public."growth-mgk_2021-11-29" OWNER TO postgres;

--
-- Name: growth-mgk_2021-11-29_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."growth-mgk_2021-11-29_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."growth-mgk_2021-11-29_id_seq" OWNER TO postgres;

--
-- Name: growth-mgk_2021-11-29_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."growth-mgk_2021-11-29_id_seq" OWNED BY public."growth-mgk_2021-11-29".id;
...
--
-- Name: soxx_2021-11-29; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."soxx_2021-11-29" (
    id integer NOT NULL,
    name text,
    off_hi double precision,
    gain_factor double precision
...
ALTER TABLE public."soxx_2021-11-29" OWNER TO postgres;

--
-- Name: soxx_2021-11-29_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."soxx_2021-11-29_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."soxx_2021-11-29_id_seq" OWNER TO postgres;

--
-- Name: soxx_2021-11-29_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."soxx_2021-11-29_id_seq" OWNED BY public."soxx_2021-11-29".id;
...
--
-- Name: growth-mgk_2021-11-29 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."growth-mgk_2021-11-29" ALTER COLUMN id SET DEFAULT nextval('public."growth-mgk_2021-11-29_id_seq"'::regclass);
...
--
-- Name: soxx_2021-11-29 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."soxx_2021-11-29" ALTER COLUMN id SET DEFAULT nextval('public."soxx_2021-11-29_id_seq"'::regclass);
...
--
-- Data for Name: growth-mgk_2021-11-29; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."growth-mgk_2021-11-29" (id, name, off_hi, gain_factor) FROM stdin;
1	amzn	-4.24188204904723	1.187008030344306
2	tsla	-6.963478791744704	1.9573577686905455
3	goog	-2.559811216263219	1.6881936053579178
4	googl	-2.2803168410906904	1.6861177351785146
5	fb	-10.737015342357925	1.3448042566776475
6	nvda	0	2.678329378382649
7	hd	-0.45755832195958357	1.6046860226737947
8	msft	-1.8886015404391054	1.583023816340574
9	aapl	-0.19308474163891587	1.3354446899406758
10	v	-21.175010072136413	1.015730883757479
11	adbe	-0.12783893677159597	1.5595354471687561
12	dis	-25.030434767130117	1
13	nflx	-3.8345049031219047	1.3581849167848556
14	ma	-17.863499530976355	1.0212463278609976
15	pypl	-39.312220453770564	1
16	crm	-3.420670387510172	1.4191974529228146
17	tmo	0	1.4578773629674981
18	acn	-1.4573185092809249	1.5121528194984013
19	cost	0	1.7486448760725921
20	nke	-4.303982663553185	1.3228719747113593
21	mcd	-1.7313821781110628	1.2142233617583242
22	txn	-3.124838875851932	1.210260906195927
23	lin	-4.830573648448033	1.313055162829648
24	low	-0.37672428074336795	1.6572000122070312
25	intu	0	1.9230405891464617
26	amd	0	2.170666464825411
27	isrg	-8.277852024161191	1.4194122360825747
28	amt	-11.61220032125254	1.3347000122070312
29	sbux	-12.098116786605894	1.1437868624045242
90	docu	-18.88404776589272	1.3443446522259537
91	cvna	-19.117404749660416	1.2291921135064277
92	hsy	-1.614498815411891	1.231848189319771
93	cmg	-13.37586846284361	1.2908461350661058
94	rblx	-3.9786227447924483	1.9209980345300932
95	nem	-24.65659942119114	1.0343539974871145
96	pltr	-40.10801730514954	1.0668354275860363
97	twtr	-40.59174639281898	1.0132801786203698
98	hlt	-9.068749569138179	1.3617714582836382
99	azo	-2.5203734197187244	1.644080178683249
100	rok	-2.1799771843487914	1.4021984743221196
101	roku	-51.17069528985514	1
102	pins	-52.80558766542751	1
103	vmw	-27.942057337097403	1
\.
...
--
-- Data for Name: soxx_2021-11-29; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."soxx_2021-11-29" (id, name, off_hi, gain_factor) FROM stdin;
1	NVDA	0	2.678329378382649
2	AVGO	-0.7701406796461141	1.3906165705738722
3	INTC	-26.75066153644109	1.0622477230544356
4	QCOM	-0.6810781118032128	1.4519162470349056
5	TXN	-3.124838875851932	1.210260906195927
6	AMD	0	2.170666464825411
7	KLAC	-2.0218780354650745	1.6063346213347043
8	MRVL	0	1.8072753475431962
9	XLNX	0	1.9752542528055481
10	AMAT	-3.570976815437743	1.7721785770039522
11	ADI	-2.9661048797655076	1.297910059299019
12	MCHP	-1.5858215677177712	1.2619617971285961
13	NXPI	-1.134604268136219	1.440036077112473
14	LRCX	0	1.440997721342913
15	MU	-9.61175589588863	1.2759590677515302
16	ASML	-6.193457460115026	1.800609771719915
17	TSM	-13.602780755755484	1.1499083670985333
18	SWKS	-19.588915590053226	1.112611261542582
19	ON	-0.5052094948742147	2.106283432388603
20	MPWR	-1.0988659521099953	1.8407541306785817
21	TER	0	1.41088878437897
22	ENTG	0	1.6429556851988292
23	QRVO	-22.9110248124741	1.018432217380926
24	WOLF	-7.552854399446119	1.63056104687015
25	STM	-4.857748036541953	1.4065807946860123
26	LSCC	-6.241808283805128	1.9623534751121203
27	UMC	-8.559997558593746	1.4076355254023254
28	MKSI	-19.148284671788772	1.124334263148286
29	OLED	-41.668001151046056	1.012046456694577
30	ASX	-21.314954017325118	1.32974913579673
\.
...
--
-- Name: growth-mgk_2021-11-29_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."growth-mgk_2021-11-29_id_seq"', 103, true);
...
--
-- Name: soxx_2021-11-29_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."soxx_2021-11-29_id_seq"', 30, true);
...
--
-- Name: growth-mgk_2021-11-29 growth-mgk_2021-11-29_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."growth-mgk_2021-11-29"
    ADD CONSTRAINT "growth-mgk_2021-11-29_pkey" PRIMARY KEY (id);
...
--
-- Name: soxx_2021-11-29 soxx_2021-11-29_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."soxx_2021-11-29"
    ADD CONSTRAINT "soxx_2021-11-29_pkey" PRIMARY KEY (id);
